package com.lokumlabs.controllers;
...
import com.lokumlabs.dto.RegistrationForm;
import com.lokumlabs.entities.Board;
import com.lokumlabs.repositories.BoardRepository;
...
public class BoardController {
	...
	public String board(@PathVariable("boardName") String boardName, Model model){
    	LOGGER.debug("Board view reuest "+boardName);
    ...
    @RequestMapping(value="/register",method=RequestMethod.POST)
   	public String boardSave(@Valid RegistrationForm regForm, BindingResult result, WebRequest request, RedirectAttributes redirectAttributes){
    ...
    @RequestMapping(value="/{boardName}/edit",method=RequestMethod.GET)
   	public String boardEdit(@PathVariable("boardName") String boardName,   Model model){
